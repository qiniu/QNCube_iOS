...
@implementation NSDate (QNCategory)
...
+ (NSString*)compareTwoTime:(double)time1 time2:(double)time2 {
    ...
    NSString *minStr = cmps.minute == 0 ? @"00" : [NSString stringWithFormat:@"0%ld",cmps.minute];
    if (cmps.minute > 9) {
    ...
    NSString *timeString = [NSString stringWithFormat:@"%@:%@:%@",hourStr,minStr,secStr];
    return timeString;
}
