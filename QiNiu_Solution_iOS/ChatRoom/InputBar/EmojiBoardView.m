...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    EmojiCollectionCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:emojiCollectionViewCellIdentify forIndexPath:indexPath];
    if (!cell) {
        cell = [[EmojiCollectionCell alloc] init];
    }
    if (indexPath.row == 23) {
        //  展示删除图案
...
- (UICollectionView *)emojiContentView {
    if (!_emojiContentView) {
        ...
        [_emojiContentView registerClass:[EmojiCollectionCell class] forCellWithReuseIdentifier:emojiCollectionViewCellIdentify];
