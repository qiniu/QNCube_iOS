...
#define QN_AVATAR_KEY @"Get_avatar"
...
#define QN_IM_ID @"QN_IM_USER_ID"
#define QN_IM_USER_NAME_KEY @"QN_IM_USER_NAME"
#define QN_IM_USER_PASSWORD_KEY @"QN_IM_USER_PASSWORD"
#define Live_Token @"Live_Token"//互动直播token

//get登录token
#define QN_Login_token  [[NSUserDefaults standardUserDefaults] stringForKey:QN_LOGIN_TOKEN_KEY]
//get头像
#define Get_avatar  [[NSUserDefaults standardUserDefaults] stringForKey:QN_AVATAR_KEY]
//get用户ID
#define Get_User_id  [[NSUserDefaults standardUserDefaults] stringForKey:QN_ACCOUNT_ID_KEY]
//get用户昵称
#define Get_Nickname  [[NSUserDefaults standardUserDefaults] stringForKey:QN_NICKNAME_KEY]
//getIM userid
#define Get_IM_ID  [[NSUserDefaults standardUserDefaults] stringForKey:QN_IM_ID]
//get IM userName
