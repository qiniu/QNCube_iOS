...
#import <QNWhiteBoardSDK/QNWhiteBoardWidgetActionEvent.h>
...
@protocol QNWhiteboardDelegate <NSObject>
/**
...
-(void)onScreenDirty;
  ...
  */
@optional
-(void) onBoardStatusChanged:(QNWBBoardStatus)status;
...
-(void) onUserList:(NSArray *)users;
  ...
  */
@optional
-(void) onUserJoin:(QNWhiteBoardRoomMember *)user;
 /**
  * 有其它用户离开了房间
  *
  * @param user 用户信息
  */
@optional
-(void) onUserLeave:(QNWhiteBoardRoomMember *)user;
