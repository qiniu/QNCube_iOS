...
@interface QNPageControl ()

@end


@implementation QNPageControl
...
-(void)initialize{
    ...
    _PageControlContentMode = QNPageControlContentModeCenter;
    _marginSpacing = 12;
    _numberOfPages=0;
    _currentPage=0;
...
- (void)setPageControlContentMode:(QNPageControlContentMode)PageControlContentMode {
...
-(void)setCurrentPage:(NSInteger)currentPage{
    ...
    if([self.delegate respondsToSelector:@selector(QNPageControlClick:index:)])
    {
        [self.delegate QNPageControlClick:self index:currentPage];
    }
...
-(void)setPageControlStyle:(QNPageControlStyle)PageControlStyle{
...
-(void)createPointView{
    ...
    switch (_PageControlStyle) {
        case QNPageControlStyelDefault:
        {
            [self CreatDotWithSize:_controlSize];
        }
            break;
        case QNPageControlStyelRectangle:
        {
            [self CreatDotWithSize:CGSizeMake(15, 2)];
        }
            break;
        case QNPageControlStyelDotAndRectangle:
        {
...
-(void)CreatDotWithSize:(CGSize)DotSize{
    ...
    if(self.frame.size.width<mainWidth){
        ...
        if (_PageControlContentMode == QNPageControlContentModeLeft && self.frame.size.width - _marginSpacing * 2 > mainWidth) {
            startX = _marginSpacing;
        }else if (_PageControlContentMode == QNPageControlContentModeRight && self.frame.size.width - _marginSpacing * 2 > mainWidth) {
