...
@interface QNWhiteBoardButtonGroup()



@end

@implementation QNWhiteBoardButtonGroup
...
- (void)updateButtons
{
    for (NSUInteger i = 0; i < _buttons.count; i++) {
        ...
        if ([_selectedIndexSet containsIndex:i]) {
            ...
            if([button isKindOfClass:[QNWhiteBoardToolbarColorButton class]])
            {
                
                QNWhiteBoardToolbarColorButton * colorBtn = (QNWhiteBoardToolbarColorButton *)button;
            ...
            else
            {
             //   button.backgroundColor = self.buttonBackgroundColor;
                [button setBackgroundImage:[UIImage imageNamed:@"toolbarBG" inBundle:[NSBundle bundleForClass:[QNWhiteBoardToolbarColorButton class]] compatibleWithTraitCollection:nil] forState:UIControlStateNormal];
            }
        }
        else {
            if([button isKindOfClass:[QNWhiteBoardToolbarColorButton class]])
