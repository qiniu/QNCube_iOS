...
@class QNWhiteBoardButtonGroup;

@protocol QNButtonGroupDelegate

@optional

- (void)buttonGroup:(QNWhiteBoardButtonGroup *)buttonGroup didSelectButtonAtIndex:(NSUInteger)index;
- (void)buttonGroup:(QNWhiteBoardButtonGroup *)buttonGroup didDeselectButtonAtIndex:(NSUInteger)index;

- (void)buttonGroup:(QNWhiteBoardButtonGroup *)buttonGroup didSelectButton:(UIButton *)button;
- (void)buttonGroup:(QNWhiteBoardButtonGroup *)buttonGroup didDeselectButton:(UIButton *)button;

@end

/** a UIView subclass containing an array of buttons
 */
@interface QNWhiteBoardButtonGroup : UIView

/** a delegate which is notified via the protocols methods, if the user has selected a button */
@property (weak, nonatomic)  NSObject<QNButtonGroupDelegate>    *delegate;
